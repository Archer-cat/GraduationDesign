...
public class CustomMediaController extends MediaController {
    ...
    protected View makeControllerView() {
        //此处的   vitamio_control  为我们自定义控制器的布局文件名称
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate

                (getResources().getIdentifier("vitamio_control", "layout", getContext().getPackageName()), this);
        v.setMinimumHeight(controllerWidth);
        //获取控件
        img_back = (ImageButton) v.findViewById(getResources().getIdentifier("vitamio_control_top_back", "id",

                context.getPackageName()));
        mFileName = (TextView) v.findViewById(getResources().getIdentifier("vitamio_control_filename", "id",
