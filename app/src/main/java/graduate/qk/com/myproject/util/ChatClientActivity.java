...
public class ChatClientActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServerInfo[] serverInfos = {new ServerInfo("连接Java Web后台", "ws://192.168.1" + "" +
                ".104:80/JSR356-WebSocket/websocket/"), new ServerInfo("连接Java Application后台", "http://192.168.229.28:8080")};// 所有连接后台
        etAddress.setText(serverInfos[1].serverAddress);// 默认选择第2个连接协议
