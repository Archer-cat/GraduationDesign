package graduate.qk.com.myproject.Tool.RecyclerViewFramWork;
...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    private final static int TYPE_HEADVIEW=1;
    private final static int TYPE_ITEM=2;
    private final static int TYPE_PROGRESS=3;
    ...
    public BaseRecyclerAdapter(Context context, List<T> list, int itemLayoutId) {
        ...
        Log.i("适配器中的itemLayoutId"+itemLayoutId);
        Log.i("适配器中的inflater"+inflater);
    }
    ...
    public BaseRecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType==TYPE_ITEM){
            ...
            return BaseRecyclerHolder.getRecyclerHolder(context,HeadView);
        }else {
    ...
    public void onBindViewHolder(final BaseRecyclerHolder holder, int position) {
        ...
        if (listener != null){
            holder.itemView.setBackgroundResource(R.drawable.ic_backgroup_image);//设置背景
        }
