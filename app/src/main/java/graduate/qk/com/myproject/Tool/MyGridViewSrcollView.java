...
public class MyGridViewSrcollView extends GridView {
    public MyGridViewSrcollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
    public MyGridViewSrcollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public MyGridViewSrcollView(Context context) {
        super(context);
    }
